...
def eval(net, dataset, save_dir=None):
    ...
    annotations_filename = './process_zoom/split_full_with_nodule_9classes/test_anno_center.csv'
    ...
    val_path = './process_zoom/split_full_with_nodule_9classes/test.txt'
